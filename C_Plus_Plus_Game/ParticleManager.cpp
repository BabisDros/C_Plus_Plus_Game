...
void ParticleManager::init()
{
	...
	GameEvents::getInstance()->m_enemyDied.addArgActionCallback(this, std::bind(&ParticleManager::onEnemyDied, this, std::placeholders::_1, std::placeholders::_2));
	...
	GameEvents::getInstance()->m_playHurtFx.addArgActionCallback(this, std::bind(&ParticleManager::onPlayerHurt, this));
	GameEvents::getInstance()->m_playerMoved.addArgActionCallback(this, std::bind(&ParticleManager::onPlayerMoved, this , std::placeholders::_1, std::placeholders::_2));
}
