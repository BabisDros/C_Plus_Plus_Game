...
{
	ParticleSystem(int emissionRate, int maxParticles, float posX, float posY, float width, float height, float lifetime, std::string texture="", float maxVelocity = 1.5f, float acceleration = 0.5f,
